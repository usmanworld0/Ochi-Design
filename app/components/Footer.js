...
return (
    <div data-scroll data-scroll-section data-scroll-speed="0.2" className='w-full h-screen bg-zinc-900 p-20 flex justify-between'>
        <div className='w=1/2 font-[Founders_Grotesk_X-Cond] h-full flex flex-col justify-between '>
        <div className='heading'>
 <h1 className='text-8xl leading-20'>EYE-</h1>
        <h1 className='text-8xl leading-20'>OPENING</h1>
        </div>
        ...
        <div className='w=1/2' >
             <h1 className='text-8xl leading-20 font-[Founders_Grotesk_X-Cond] pb-10 '>PRESENTATIONS</h1>
             {['Facebook','Instagram','Behance','LinkedIn'].map((items,index)=>{
                            return <a key={index} className='block font-light font-3xl' href='#'>{items}</a>
                    })}
             <div className='dets flex justify-between'>
                    
              <div className='contactleft-info mt-8 text-white '>
                
                    <div className='address mb-4 pt-20 '>
                    ...
                    <div className='email mb-4'>
                         ...
                         <a href='mailto:muhammad.usman@gmail.com' className='text-sm hover:underline'>
                                world.usman.businessgmail.com
                         </a>
                    </div>
                    <div className='copyright'>
                         <p className='text-sm'>© 2025 Muhammad Usman. All rights reserved.</p>
                    </div>
             </div>
             <div className='contactright-info mt-8 text-white '>
                             {['Home','Services','Insights','Our-mission','About'].map((items,index)=>{
                            return <a key={index} className='block font-light font-3xl underline-offset-3 underline' href='#'>{items}</a>
                    })}
             </div>
