...
const Navbar = () => {
  return (
    <div className='fixed z-[999] w-full px-6 sm:px-10 md:px-15 py-4 sm:py-6 md:py-7 font-["Neue Montreal"] flex justify-between items-center'>
        <div className='logo'>
            <svg className="w-12 h-5 sm:w-16 sm:h-6 md:w-[60px] md:h-[25px] lg:w-[72px] lg:h-[30px]" viewBox="0 0 72 30" fill="none" xmlns="http://www.w3.org/2000/svg">
        ...
        <div className='links hidden md:flex gap-6 lg:gap-8 xl:gap-10'>
            {["Service","Our Work","About Us","Insights","Contact"].map((item,index)=>(
                <a key={index} className={`text-base lg:text-lg font-light ${index===4 && "lg:ml-20 xl:ml-34"}`}>{item}</a>
            ))}
